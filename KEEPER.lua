...
‏
   ...
   ‏
   ‏
🔍┊ اهلاً بك في سورس مكسيكو❗️

  🌐┇MEXICO TEAM


[🐯┇[قناه سورس](http://t.me/MEXIC_TV)

[📋┇قناه شروحات سورس](http://t.me/MEXIC_TV)

[🗂┇ قناه ملفات سورس](http://t.me/MEXIC_TV) 

[📬┇[لـ تواصل](http://t.me/MXC_BOT)
‏
]]
                send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end end																																											
...
-----------------------------------------
        if text == "مكسيكو" or text == "MEXICO" then
        	if not database:get('lock:add'..msg.chat_id_) then 
local KEEPER = {"عيون 👀 مكسيكو امرني 🤠🍃","اي تفضل اغاتي🌝🍃","شرايد مني 😐💔","ها حياتي😻🍃" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
----------------------------------------- 
